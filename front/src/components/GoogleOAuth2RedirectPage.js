...
function GoogleOAuth2RedirectPage() {
    ...
    const getToken = async (code) => {
        ...
        const response = await axios(`https://oauth2.googleapis.com/token?grant_type=authorization_code&client_id=${REST_API_KEY}&redirect_uri=${REDIRECT_URI}&client_secret=${SECRET_KEY}&code=${code}`, {
            method: 'POST',
            headers: {
